...
const en = {
  ...
  copHint:
    "Heat out ÷ electricity in, per day. Days with under 0.1 kWh of electricity are left out.",
...
const nb: typeof en = {
  ...
  copHint:
    "Varme ut ÷ strøm inn, per døgn. Døgn med under 0,1 kWh strøm er utelatt.",
